...
namespace WatcherRepository
{
    ...
    {
        private readonly IWatcherOption _option;
        ...
        public AgentController(IWatcherOption option, IWatcherRepository watcherRepository, ILogger<AgentController> logger)
        {
